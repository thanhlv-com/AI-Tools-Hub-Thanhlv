...
export default function DDLCompare() {
  ...
  const handleAnalyze = async () => {
    if (!currentDDL.trim() || !newDDL.trim()) {
      toast({
        title: t('ddl.error'),
        description: t('ddl.missingFields'),
        variant: "destructive"
      });
      return;
    }
    ...
    try {
      ...
      toast({
        ...
        description: `${t('ddl.result')} (${modelToUse})`,
      });
    } catch (err) {
  ...
  const copyToClipboard = (text: string) => {
    ...
    toast({
      ...
      description: t('ddl.scriptCopied'),
    });
  };
  ...
  const handleLoadFromHistory = (historyItem: DDLAnalysisHistory) => {
    ...
    toast({
      title: t('common.success'),
      description: `${t('ddl.loadFromHistory')}: ${historyItem.title}`,
    });
  };
        ...
        <Card className="shadow-card">
          ...
          <CardContent>
            <SearchableSelect
              ...
              placeholder={t('ddl.selectDatabase')}
        ...
        <Card className="shadow-card">
          <CardHeader>
            <CardTitle className="flex items-center space-x-2">
              ...
              <span>{t('common.select')} Model</span>
            </CardTitle>
            <CardDescription>
        ...
        <Card className="shadow-card">
          <CardHeader>
            <CardTitle className="flex items-center space-x-2">
              ...
              <span>{t('ddl.currentDDL')}</span>
            </CardTitle>
            <CardDescription>
              {t('ddl.currentDDLPlaceholder')}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Textarea
  ...
  email VARCHAR(100)
            ...
            <div className="mt-2 flex items-center justify-between">
              <Badge variant="secondary" className="text-xs">
                {t('translation.characterCount', { count: currentDDL.length })}
              </Badge>
              <Button
                variant="ghost"
                size="sm"
        ...
        <Card className="shadow-card">
          <CardHeader>
            <CardTitle className="flex items-center space-x-2">
              ...
              <span>{t('ddl.targetDDL')}</span>
            </CardTitle>
            <CardDescription>
              {t('ddl.targetDDLPlaceholder')}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Textarea
  ...
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
            ...
            <div className="mt-2 flex items-center justify-between">
              <Badge variant="secondary" className="text-xs">
                {t('translation.characterCount', { count: newDDL.length })}
              </Badge>
              <Button
                variant="ghost"
                size="sm"
